...
$$
\frac
  {\begin{verbatim{"Probability that you'd get this data if the crazy idea is TRUE"}\end{verbatim}}
	{\begin{verbatim{Probability that you'd get this data if the crazy idea is BS}\end{verbatim}}
$$
