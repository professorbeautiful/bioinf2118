...
```{css}
  ...
  wellPanel {padding: 1px !important;}
...
WIDE = function(x) (paste0('', x, 
                           paste(collapse='', rep('.', 30))))
output$whichFollows = renderUI(
  wellPanel(
          h4(style='text-align:center', 
             "Probabilities must add to one. Pick which is dependent on the other three."),
  ...
  renderUI(
    wellPanel(style='text-align:center',
        ...
        fluidRow(style='text-align:center',
            column(12, offset=4, textInput(width = '200px',
                      "dataInputID",
                      value = "1 1 1 1",
...
#    fluidRow(
      ...
      # column(12,   uiOutput('prob_pos_UI')), 
      # 
      # #https://stackoverflow.com/questions/51460955/how-to-make-kable-table-reactive-in-shiny-app-shiny-kable
