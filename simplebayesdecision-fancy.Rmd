...
source("conditionalPanelWithCheckbox.R")
 conditionalPanelWithCheckbox(
  ...
  initialValue = TRUE)
#inclRmd("simplebayesdecision-info.Rmd")
# simplebayesdecision-info.Rmd.inclOutput.Rmd
# is created but not appearing in doc.
...
fluidPage(
  ...
  fluidRow(
    column(6, 
           ...
           radioButtons('plotChoice', label='', choiceValues=0:2,
                        choiceNames = c('decision plot', 'people plot #1',  'people plot #2'), 
                        inline = TRUE),
