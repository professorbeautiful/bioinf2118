...
Odds_and_predictive_values = list(
  fluidRow(
    column(
      6,
      wellPanel(odds_display)
    ),
    column(
      6,
      wellPanel(predictiveValueDisplay)
    )
  )
)
```
