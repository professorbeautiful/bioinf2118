...
renderPlot({
  ...
  Wbetter = 1 + (E.loss.W < E.loss.T) 
  colorWbetter = c('red', 'green')[Wbetter]
  Tbetter = 1 + (E.loss.W > E.loss.T) 
  colorTbetter = c('red', 'green')[Tbetter]
  lines (horiz.values, E.loss.W, pch= "W", col=colorWbetter, lwd=3)
  lines (horiz.values, E.loss.T, pch= "T", col=colorTbetter, lwd=3)
  points(horiz.values, E.loss.W, pch= "W", col=colorWbetter, cex=2*Wbetter)
  points(horiz.values, E.loss.T, pch= "T", col=colorTbetter, cex=2*Tbetter)
