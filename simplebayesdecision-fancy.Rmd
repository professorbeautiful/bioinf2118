...
output$parameterUI = renderUI(
  {
    dashOrNot = function(s) {
      cat('dashOrNot:', s, ' ', input$parameterInputID, '\n')
      HTML(s)
      # ifelse(s == input$parameterInputID,
      #        dashWrap(s), s)
    }
    wellPanel(
  fluidRow(
